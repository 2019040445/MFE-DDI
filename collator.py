...
def collator(batch, max_d_node=256,
    ...
    AMDE collator
    '''
    # n_samples = len(batch) # batchsize=4
    # print('n_samples1: ',n_samples)
    n_samples = drug1_node.size()[0] #batchsize
    # print('n_samples2: ',n_samples)    
    ...
    # print(n_nodes_largest_graph_1,n_nodes_largest_graph_2) 一个batchsize内所有分子中原子个数的最大值
    ...
    for i in range(n_samples):
        ...
        # print(n_nodes_1)
        # print(adj_1.shape,adj_2.shape) 邻接矩阵：原子数n*n
        # print(node_fts_1.shape,node_fts_2.shape) 节点特征 n*75
        # print(edge_fts_1.shape, edge_fts_2.shape) 边特征 n*n*4
    ...
    # print("drug1_node: ",drug1_node.shape) # [8, 256, 9]
    # print("node_tensor_1: ",node_tensor_1.shape) # [8, 9, 75]
        # print(adjacency_tensor_1.shape,adjacency_tensor_2.shape)
        # print(node_tensor_1.shape,node_tensor_2.shape)
        # print(edge_tensor_1.shape,edge_tensor_2.shape)
    # assert False
